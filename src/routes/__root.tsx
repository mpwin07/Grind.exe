...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "grind.exe | AI-Powered Problem Solver" },
      { name: "description", content: "Track your grind.exe with AI-suggested problems, streak tracking, and gamified milestones." },
      { name: "author", content: "grind.exe" },
      { property: "og:title", content: "grind.exe" },
      { property: "og:description", content: "AI-powered LeetCode problem tracking and recommendations" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@leetcode" },
    ],
    links: [
